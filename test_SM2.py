...
sys_para: SM2.ECC = SM2.ECC(modP=0x8542D69E4C044F18E8B92435BF6FF7DE457283915C45517D722EDB8B08F1DFC3,
...
print(res)
# 签名样例所用的公钥
publicKey: SM2.FFCoord = SM2.FFCoord(SM2.AffineDot(0x0AE4C7798AA0F119471BEE11825BE46202BB79E2A5844495E97C04FF4DF2548A,
...
print('\n================================== Encrypt and Decrypt  ======================================')
for i in range(512):
    secret, C1Len, C2Len = SM2.SM2EncryptMsg(SM2.bytes2bits(msg), sys_para, publicKey)
    print(f'\nmsg: {msg}\n{secret}\n')
    try:
...
print('\n================================== Sign and Verify  ======================================')
for i in range(100):
    ZA_id = SM2.ZAGenerator(sys_para, publicKey, SM2.bytes2bits(SenderID))
    # 生成签名
