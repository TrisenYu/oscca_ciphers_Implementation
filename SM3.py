...
"""
:cite:https://oscca.gov.cn/sca/xxgk/2010-12/17/1002389/files/302a3ada057c4a73830536d03e683110.pdf
...
def SM3Hash(isNeed: bool = False, para_str: str = "") -> str:
    """
    SM3Hash 入口。
        :param isNeed: 不需要则手动输入。以后应能支持任意字节输入。
        :param para_str: 可能的目的参数。
        :return: sm3 十六进制杂凑值。
    """
    
    def initPlaintext(_isNeed: bool = False, _para_str: str = "") -> str:
        msg = input() if not _isNeed else _para_str
    ...
    plaintext_bin = initPlaintext(isNeed, para_str)
